...
REPORTINFO_CODES = {
    ...
    "Hold:0":   [1201, "Hold complete"],
    "Hold:1":   [1202, "Hold in-progress"],
    "Door:0" :  [1301, "Door closed. Ready to resume"],
    "Door:1" :  [1302, "Machine stopped"],
    "Door:2" :  [1303, "Door opened"],
    "Door:3" :  [1304, "Door closed and resuming"],
